...
//Create node containers
	  ...
	  if (((numtasks == 1) && (rank == 0)) || ((numtasks == 2) && (rank == 0)) || ((numtasks == 4) && (rank == 1))){
		...
		//Inner ring of hub1
 		//Inner ring 0
                  ...
                  NetDeviceContainer hub1toinner0container = hub1toinner0.Install(hubs.Get(1), hub1inners.Get(0));
                //Inner ring 1
                  ...
                  NetDeviceContainer hub1toinner1container = hub1toinner1.Install(hubs.Get(1), hub1inners.Get(1));
                //Inner ring 2
                  ...
                  NetDeviceContainer hub1toinner2container = hub1toinner2.Install(hubs.Get(1), hub1inners.Get(2));
                //Inner ring 3
                  ...
                  NetDeviceContainer hub1toinner3container = hub1toinner3.Install(hubs.Get(1), hub1inners.Get(3));
                //Inner ring 4
                  ...
                  NetDeviceContainer hub1toinner4container = hub1toinner4.Install(hubs.Get(1), hub1inners.Get(4));
                //Inner ring 5
                  ...
                  NetDeviceContainer hub1toinner5container = hub1toinner5.Install(hubs.Get(1), hub1inners.Get(5));
                //Inner ring 6
                  ...
                  NetDeviceContainer hub1toinner6container = hub1toinner6.Install(hubs.Get(1), hub1inners.Get(6));
                //Inner ring 7
                  ...
                  NetDeviceContainer hub1toinner7container = hub1toinner7.Install(hubs.Get(1), hub1inners.Get(7));
	  ...
	  if (((numtasks == 1) && (rank == 0)) || ((numtasks == 2) && (rank == 1)) || ((numtasks == 4) && (rank == 2))){
		...
		//Inner ring 0
                  ...
                  NetDeviceContainer hub2toinner0container = hub2toinner0.Install(hubs.Get(2), hub2inners.Get(0));
                //Inner ring 1
                  ...
                  NetDeviceContainer hub2toinner1container = hub2toinner1.Install(hubs.Get(2), hub2inners.Get(1));
                //Inner ring 2
                  ...
                  NetDeviceContainer hub2toinner2container = hub2toinner2.Install(hubs.Get(2), hub2inners.Get(2));
                //Inner ring 3
                  ...
                  NetDeviceContainer hub2toinner3container = hub2toinner3.Install(hubs.Get(2), hub2inners.Get(3));
                //Inner ring 4
                  ...
                  NetDeviceContainer hub2toinner4container = hub2toinner4.Install(hubs.Get(2), hub2inners.Get(4));
                //Inner ring 5
                  ...
                  NetDeviceContainer hub2toinner5container = hub2toinner5.Install(hubs.Get(2), hub2inners.Get(5));
                //Inner ring 6
                  ...
                  NetDeviceContainer hub2toinner6container = hub2toinner6.Install(hubs.Get(2), hub2inners.Get(6));
                //Inner ring 7
                  ...
                  NetDeviceContainer hub2toinner7container = hub2toinner7.Install(hubs.Get(2), hub2inners.Get(7));
		...
		//Inner ring 0
                  ...
                  NetDeviceContainer hub3toinner0container = hub3toinner0.Install(hubs.Get(3), hub3inners.Get(0));
                //Inner ring 1
                  ...
                  NetDeviceContainer hub3toinner1container = hub3toinner1.Install(hubs.Get(3), hub3inners.Get(1));
                //Inner ring 2
                  ...
                  NetDeviceContainer hub3toinner2container = hub3toinner2.Install(hubs.Get(3), hub3inners.Get(2));
                //Inner ring 3
                  ...
                  NetDeviceContainer hub3toinner3container = hub3toinner3.Install(hubs.Get(3), hub3inners.Get(3));
                //Inner ring 4
                  ...
                  NetDeviceContainer hub3toinner4container = hub3toinner4.Install(hubs.Get(3), hub3inners.Get(4));
                //Inner ring 5
                  ...
                  NetDeviceContainer hub3toinner5container = hub3toinner5.Install(hubs.Get(3), hub3inners.Get(5));
                //Inner ring 6
                  ...
                  NetDeviceContainer hub3toinner6container = hub3toinner6.Install(hubs.Get(3), hub3inners.Get(6));
                //Inner ring 7
                  ...
                  NetDeviceContainer hub3toinner7container = hub3toinner7.Install(hubs.Get(3), hub3inners.Get(7));
